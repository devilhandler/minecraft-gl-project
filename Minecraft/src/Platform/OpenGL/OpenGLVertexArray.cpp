...
namespace Minecraft
{
	...
	void OpenGLVertexArray::AddVertexBuffer(const Minecraft::Ref<VertexBuffer>& vertexBuffer)
	{
	...
	void OpenGLVertexArray::SetIndexBuffer(const Minecraft::Ref<IndexBuffer>& indexBuffer)
	{
		glBindVertexArray(m_RendererID);
		indexBuffer->Bind();
